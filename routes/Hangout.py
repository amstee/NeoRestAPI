...
KEY_FILE = {
  ...
  "private_key": "-----BEGIN PRIVATE KEY-----\nMIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQDR3Z+9E86VhQHX\nTyk" +
                 "0j5TZILSFq2XnmRjJ2/4buQhfNVS6YDRRPA2r/OpmSMPEYAfqGx4k+dWE4sq4\nm7q1d2jiy2aRsfTc3GiLJJvsC0hmixgGf4Sl" +
                 "MCKNkEqLc1fzmyAp3ryj+NBwiXrN\nUavCfzMa4sjeOZYMR62sswOC7E+hZRJXqMZPCnYF7/BceYL14ohHm9uGimhWHgu+\nkP7" +
                 "POpNj5YC6bw3LjgLBSPZMF2lPYkIx7WXqlyB/Gv4OGgl5H4mMHis0WFA/SYkg\nxFoXzU9mwzYnenprhd2/VsgRvgOgBsXZda2I" +
                 "8fRM+dL1V+Fn1BahRGF0eii6s72L\niJTSOx5vAgMBAAECggEAHTehmY08YYyW6QbYUbz7mA75kvJ9yXSDAvdhtTJZfAfM\nt/X" +
                 "U0sptjNg1OfA/cQN9lpYX6EXv+AQq/PCRWdo5+/kdWoNP97+nvldmbcJUXhJX\nUfBG40iERvkjp65zPDMIk0uzL5DgVAqP0i3g" +
                 "n79dugyAso+J2EPSZgy2HHAR1gIf\nh2ZUZPDt9AXvnhx6T2IbkSl2HDMjYTn2F/TSVkfhNHZdSBT/+i2yPNHRJBxzUQlS\nzi" +
                 "8jkQqA/tEoEtSprs5m8m91TTn3wkpFM25oNCqWcatzXEUg9lB3qhJeq3bBQUFC\ndNECfyk0unriBEDvlBvAD/IHoqeMEYUiEem" +
                 "ee8McgQKBgQD5whO1DUL95b53hV96\n6BjQHH27v1yeg79awd5jY1vpM9KYUWgUq1n6DJgr1bzLObvAX2ojw3GBFmtXC4X2\niT" +
                 "oSJdO48Ti9HTK4rNz9l3tVGF1AdHG+8DKP4JSiQvFD7j66DjDRZ+7ASAXsSVIb\n8j2H3Vshj2gkSomSyTkCq3+UXwKBgQDXHFH" +
                 "1cao1NYU08FnhHQorc12q5gHq63jc\nQTB3a5VHo5J3UxP9hp+m/mzV99MO1eKOLnzsoKK0InsowAEmCAYTmi++HIlE5oyr\n7" +
                 "gXJSygKzAtcLK3nCw3HAkdYfChPPP158nPndaS1GCe88jJU+V3gQP2TQ3rgmzpX\nAUgKT/0v8QKBgQDSBnFaE//c0IDds0t6aI" +
                 "jNINhetGonZnTY1iS0AU6+CXUz32kd\n0IZGbqbcXc14PGF1QQdZcbYWLosvVKJfkkBCGIs1f6wN4+rOP5dKrULqaSWp2QH5\n" +
                 "5bUvJlT3KkIGtOcMwHgu8C5mhWptq66fj5JMmUlULGsP8ZpE1G/bneoYEwKBgGKV\nTQ5yeDIIhDLd0CM2HtoI9i2DWe+i2PIAQ" +
                 "kkImhKJ6W8cOPYgw3xR7+kjuat75GeK\n8J+1gruRbeYgEKawWLCVIjo7c8GK8388B5TYB9Li7nXg2BYh37+L0MzBoeumpPhF\n" +
                 "YE78gG6qUlPqn5yH6DkFL/FUpLTZDySeprhrLjrRAoGAY4A+w/+MsEuseamRR1BC\n1M2NZwD/Yj7skN8XR8Jo/jnAXg4QdAoNa" +
                 "Vr5mJdVccF9N0u9sVUdHrkHoWIdjJ9I\nO4e0WQqikm7cvamzwoQ1ur/ITahdxwLtft9M+wl208KEGzZpRBs7TOvKqxy6+SyC\n" +
  ...
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/starting-account-oxs2g8j3eirm%40"+
                          "neobot-1531083330987.iam.gserviceaccount.com"
}


def encodePostBackPayload(hangout_email, message_text, link):
    try:
        payload = {
...
def IsUserLinked(hangout_email):
...
def HangoutCircleModelSend(senderID, circle, text_message):
    ...
    for targetUser in circleTargets:
        ...
        if senderID != targetUserData.id and targetUserData.hangout_email is not None and \
                len(targetUserData.hangout_email) > 0:
            SendMessage(targetUserData.hangout_email, text_message)
